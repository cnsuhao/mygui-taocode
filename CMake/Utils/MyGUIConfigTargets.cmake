...
function(mygui_install_target TARGETNAME SUFFIX)
	install(TARGETS ${TARGETNAME}
		RUNTIME DESTINATION "bin${MYGUI_RELEASE_PATH}" CONFIGURATIONS Release Release-iphoneos Release-iphonesimulator None ""
		LIBRARY DESTINATION "lib${MYGUI_LIB_RELEASE_PATH}${SUFFIX}" CONFIGURATIONS Release Release-iphoneos Release-iphonesimulator None ""
		ARCHIVE DESTINATION "lib${MYGUI_LIB_RELEASE_PATH}${SUFFIX}" CONFIGURATIONS Release Release-iphoneos Release-iphonesimulator None ""
		FRAMEWORK DESTINATION "${MYGUI_FRAMEWORK_PATH}" CONFIGURATIONS Release Release-iphoneos Release-iphonesimulator None ""
	)
	install(TARGETS ${TARGETNAME}
	...
	install(TARGETS ${TARGETNAME}
		RUNTIME DESTINATION "bin${MYGUI_DEBUG_PATH}" CONFIGURATIONS Debug Debug-iphoneos Debug-iphonesimulator
		LIBRARY DESTINATION "lib${MYGUI_LIB_DEBUG_PATH}${SUFFIX}" CONFIGURATIONS Debug Debug-iphoneos Debug-iphonesimulator
		ARCHIVE DESTINATION "lib${MYGUI_LIB_DEBUG_PATH}${SUFFIX}" CONFIGURATIONS Debug Debug-iphoneos Debug-iphonesimulator
		FRAMEWORK DESTINATION "${MYGUI_FRAMEWORK_PATH}" CONFIGURATIONS Debug Debug-iphoneos Debug-iphonesimulator
	)
...
function(mygui_config_common TARGETNAME)
	set_target_properties(${TARGETNAME} PROPERTIES
		ARCHIVE_OUTPUT_DIRECTORY_RELEASE 					${MYGUI_BINARY_DIR}/lib/Release
    	ARCHIVE_OUTPUT_DIRECTORY_RELEASE-IPHONESIMULATOR 	${MYGUI_BINARY_DIR}/lib/Release
    	ARCHIVE_OUTPUT_DIRECTORY_RELEASE-IPHONEOS		 	${MYGUI_BINARY_DIR}/lib/Release
    	ARCHIVE_OUTPUT_DIRECTORY_DEBUG 						${MYGUI_BINARY_DIR}/lib/Debug
    	ARCHIVE_OUTPUT_DIRECTORY_DEBUG-IPHONESIMULATOR 		${MYGUI_BINARY_DIR}/lib/Debug
    	ARCHIVE_OUTPUT_DIRECTORY_DEBUG-IPHONEOS		 		${MYGUI_BINARY_DIR}/lib/Debug
    	LIBRARY_OUTPUT_DIRECTORY_RELEASE 			    	${MYGUI_BINARY_DIR}/lib/Release
    	LIBRARY_OUTPUT_DIRECTORY_RELEASE-IPHONESIMULATOR	${MYGUI_BINARY_DIR}/lib/Release
    	LIBRARY_OUTPUT_DIRECTORY_RELEASE-IPHONEOS			${MYGUI_BINARY_DIR}/lib/Release
    	LIBRARY_OUTPUT_DIRECTORY_DEBUG 				    	${MYGUI_BINARY_DIR}/lib/Debug
    	LIBRARY_OUTPUT_DIRECTORY_DEBUG-IPHONESIMULATOR  	${MYGUI_BINARY_DIR}/lib/Debug
    	LIBRARY_OUTPUT_DIRECTORY_DEBUG-IPHONEOS		  		${MYGUI_BINARY_DIR}/lib/Debug
    	RUNTIME_OUTPUT_DIRECTORY_RELEASE 			    	${MYGUI_BINARY_DIR}/bin/Release
    	RUNTIME_OUTPUT_DIRECTORY_RELEASE-IPHONESIMULATOR	${MYGUI_BINARY_DIR}/bin/Release
    	RUNTIME_OUTPUT_DIRECTORY_RELEASE-IPHONEOS			${MYGUI_BINARY_DIR}/bin/Release
    	RUNTIME_OUTPUT_DIRECTORY_DEBUG 				    	${MYGUI_BINARY_DIR}/bin/Debug
    	RUNTIME_OUTPUT_DIRECTORY_DEBUG-IPHONESIMULATOR  	${MYGUI_BINARY_DIR}/bin/Debug
    	RUNTIME_OUTPUT_DIRECTORY_DEBUG-IPHONEOS		  		${MYGUI_BINARY_DIR}/bin/Debug
	)
