option(MYGUI_CREATE_PACKAGE "Create package." TRUE)
...
if (MYGUI_CREATE_PACKAGE)
	...
	set(CPACK_PACKAGE_INSTALL_DIRECTORY "NoahMyGUI")
	...
	if (WIN32 AND NOT UNIX)
		set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS " WriteRegStr HKCU \\\"Environment\\\" \\\"MyGUI_HOME\\\" $INSTDIR ")
		set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS " DeleteRegValue HKCU \\\"Environment\\\" \\\"MyGUI_HOME\\\" ")
		...
		SET(CPACK_NSIS_MUI_ICON  "${MYGUI_SOURCE_DIR}/Common/Base\\\\mygui.ico")
