...
function(install_dll_file DEBUG_FILEPATH RELEASE_FILEPATH FILENAME)
	...
	if (EXISTS ${RELEASE_FILEPATH}${FILENAME}.dll)
		install(FILES
...
if (MYGUI_TRY_TO_COPY_DLLS)
	...
	set(OGRE_LIB_DIR $ENV{OGRE_HOME}/lib)
	string( REGEX REPLACE "\\\\" "/" OGRE_LIB_DIR ${OGRE_LIB_DIR} )
	if (MYGUI_RENDERSYSTEM EQUAL 3)
		if (EXISTS ${OGRE_LIB_DIR}/../bin/debug/OgreMain_d.dll OR EXISTS ${OGRE_LIB_DIR}/../bin/release/OgreMain.dll)
		...
		elseif (EXISTS "${OGRE_LIB_DIR}/OgreMain_d.dll" OR EXISTS "${OGRE_LIB_DIR}/OgreMain.dll")
			set(DEBUG_DLLS_DIR ${OGRE_LIB_DIR})
			set(RELEASE_DLLS_DIR ${OGRE_LIB_DIR})
			MESSAGE(STATUS "    DLL's was copied from lib")
		elseif (EXISTS ${OGRE_BUILD}/bin/debug/OgreMain_d.dll OR EXISTS ${OGRE_BUILD}/bin/release/OgreMain.dll)
