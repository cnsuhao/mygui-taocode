...
namespace MyGUI
{
	...
	public:
        ...
        /** @see IRenderTarget::doRotatedRender */
        virtual void doRotatedRender(IVertexBuffer* _buffer, ITexture* _texture, size_t _count, float _angle, float _centerX, float _centerY) {}
