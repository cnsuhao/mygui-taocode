...
namespace MyGUI
{
	...
	public:
		...
		/** Set line points. */
		void setPoints(const vector<FloatPoint>::type& _points);
	...
	private:
		...
		float mLineWidth;
		vector<FloatPoint>::type mLinePoints;
		float mLineLength;

		vector<FloatPoint>::type mResultVerticiesPos;
		vector<FloatPoint>::type mResultVerticiesUV;
