...
namespace MyGUI
{
	...
	public:
		typedef delegates::CDelegate5<const IntCoord&, const IntCoord&, const IntCoord&, IntCoord&, float> FrameAction;
		...
		*/
        ...
        void setControlCoord(const IntCoord& _value);
