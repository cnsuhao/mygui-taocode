...
namespace MyGUI
{
	...
	*/
	...
	public:
		...
		/* Enable or disable progress auto decreas */
		void setProgressAutoDecrease(bool _value);
		/** Get progress auto decreas flag */
		bool getProgressAutoDecreas() const;

		/* set progress auto decreas time*/
		void resetProgressAutoDecreasTime(size_t _value);
	...
	private:
		void frameDecrease(float _time);
	...
	private:
		...
		bool mAutoDecrease;
		float mAutoDecreaseTime;
		float mUsedDecreaseTime;
