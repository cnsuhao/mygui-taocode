...
namespace MyGUI
{
	...
	public:
		...
		virtual void doRender(RenderItem* _render);
	...
	protected:
        ...
        struct RenderGlyph
        {
            ...
            RenderGlyph() : mRenderItem(nullptr), mCountVertex(0) {}
            RenderGlyph(RenderItem* _render, size_t _countvertex) : mRenderItem(_render), mCountVertex(_countvertex) {}
        };

        typedef map<ITexture*, RenderGlyph>::type RenderGlyphMap;
        RenderGlyphMap mRenderGlyphMap;
	};
