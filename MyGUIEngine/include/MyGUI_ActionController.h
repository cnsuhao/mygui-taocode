...
namespace MyGUI
{
	...
	namespace action
	{
		...
		void MYGUI_EXPORT frictionalMoveFunction(const IntCoord& _startRect, const IntCoord& _destRect, const IntCoord& _controlRect, IntCoord& _result, float _current_time);
		...
		*/
		template <int N>
		inline void acceleratedMoveFunction(const IntCoord& _startRect, const IntCoord& _destRect, const IntCoord& _controlRect, IntCoord& _result, float _current_time)
		{
		...
		template <int N>
		inline void jumpMoveFunction(const IntCoord& _startRect, const IntCoord& _destRect, const IntCoord& _controlRect, IntCoord& _result, float _current_time)
		{
		...
		void MYGUI_EXPORT inertionalMoveFunction(const IntCoord& _startRect, const IntCoord& _destRect, const IntCoord& _controlRect, IntCoord& _result, float _current_time);

        void MYGUI_EXPORT curveMoveFunction(const IntCoord& _startRect, const IntCoord& _destRect, const IntCoord& _controlRect, IntCoord& _result, float _current_time);
