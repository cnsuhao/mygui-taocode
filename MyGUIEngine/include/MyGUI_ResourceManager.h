...
namespace MyGUI
{
	...
	public:
		...
		typedef map<std::string, IResource*>::type MapResource;
	...
	private:
		...
		typedef map<std::string, LoadXmlDelegate>::type MapLoadXmlDelegate;
		MapLoadXmlDelegate mMapLoadXmlDelegate;

		MapResource mResources;

		typedef vector<IResource*>::type VectorResource;
