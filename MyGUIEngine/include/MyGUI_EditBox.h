	...
	*/
	...
	public:
		...
		*/
        ...
        void setShowDraggingTextScrollBar(bool _value);

        void setKeySetFocusEvent(const std::string& _name);

        void setCarriageReturnEvent(const std::string& _name);

        bool isShowDraggingTextScrollBar() const;
	...
	protected:
        ...
        IntPoint mViewOffsetBeforeDrag;

        bool    mShowDraggingTextScrollBar;

        std::string mKeySetFocusEvent;

        std::string mCarriageReturnEvent;
	};
